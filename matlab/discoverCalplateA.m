...
% options
rawDataFile = 'calplate_id_001.csv';
...
marker_all_locs = [16.5 16.5 0; -21 16.5 0; -58.5 16.5 0; 25 -76.5 0; -42 -76.5 0];
...
for rowIdx = 1:size(allData,1)
    ...
    % select the transformation that gives the lowest RMSE with our a
    % priori expectation
